...
const Storeitem = ({ product: { id, title, price, category, image } }) => {
  ...
  return (
    <div className="border-l border-r py-3 bg-clr-bg px-4 group relative overflow-hidden flex flex-col gap-4 animate__animated animate__fadeIn">
      <div className="">
